...
namespace SCManager.Data.Migrations
{
    ...
    [Migration("20200601144901_IsBoolChangedToIsBanned")]
    partial class IsBoolChangedToIsBanned
    {
            ...
            modelBuilder.Entity("SCManager.Data.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasIndex("LastUpdatedByUserId")
                        .IsUnique()
                        .HasFilter("[LastUpdatedByUserId] IS NOT NULL");
            ...
            modelBuilder.Entity("SCManager.Data.Models.ApplicationUser", b =>
                {
                    b.HasOne("SCManager.Data.Models.ApplicationUser", "LastUpdatedByUser")
                        ...
                        .HasForeignKey("SCManager.Data.Models.ApplicationUser", "LastUpdatedByUserId");
                });
